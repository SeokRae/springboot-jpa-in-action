package kr.seok.querydsl.domain.repository.support;
...
public abstract class Querydsl4RepositorySupport {
    ...
    /* 카운트 쿼리 추가 */
    protected <T> Page<T> applyPagination(
            Pageable pageable, Function<JPAQueryFactory, JPAQuery<T>> contentQuery, Function<JPAQueryFactory, JPAQuery<T>> countQuery) {
